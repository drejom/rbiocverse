 ...
 */
router.get('/content/:section', asyncHandler(async (req, res) => {
 ...
 */
router.get('/reports/clusters', asyncHandler(async (req, res) => {
  if (!stateManager) {
 ...
 */
router.get('/analytics/adoption/:version', asyncHandler(async (req, res) => {
