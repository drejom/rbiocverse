...
export function AccountUsage({ getAuthHeader }) {
  const [data, setData] = useState([]);
  const [days, setDays] = useState(30);
  const [loading, setLoading] = useState(true);
  const [sortConfig, setSortConfig] = useState({ key: 'computeHours', direction: 'desc' });
        ...
        <table className="admin-table">
          ...
          <tfoot>
            <tr>
              ...
              <td><strong>{new Set(data.flatMap(d => d.uniqueUsers)).size}</strong></td>
